...
Unit testing of cryptographic primitives and the various system components was usded throughout the software development process on all supported platforms:
\begin{itemize}
