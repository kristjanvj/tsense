...
be padded if it isn't divisable by 16. That is, given the datastring
$x$ of length $n_x$, the padded string $x'$ is produced if $16 \nmid
n_x$, such that $16 \mid n_{x'}$. Otherwise, $x$ is used as-is. We use
Zero Padding, that is all the bytes required to be padded are padded
with zero.\cite[pp343]{menzes1996}.  The lengths of the
